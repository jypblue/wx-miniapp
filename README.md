...
> secondary Development Based on [wxapp-boilerplate](https://github.com/cantonjs/wxapp-boilerplate)

根据[wxapp-boilerplate](https://github.com/cantonjs/wxapp-boilerplate)整理适合自己的微信小程序开发模板工程
